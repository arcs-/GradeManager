...
public class HSVColorPickerDialog extends AlertDialog {
	...
	private static final int CONTROL_SPACING_DP = 10;
	...
	private static class HSVColorWheel extends View {
		...
		protected void onDraw(Canvas canvas) {
			if (bitmap != null) {
				...
				canvas.drawLine(selectedPoint.x - pointerLength, selectedPoint.y, selectedPoint.x + pointerLength, selectedPoint.y,
						pointerPaint);
				canvas.drawLine(selectedPoint.x, selectedPoint.y - pointerLength, selectedPoint.x, selectedPoint.y + pointerLength,
						pointerPaint);
			}
		}
		...
		protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
			...
			int width, height;
			/*
			 * Make the view quadratic, with height and width equal and as large
			 * as possible
			 */
